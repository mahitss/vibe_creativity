...
export function MissionControlCockpit() {
  ...
  return (
    <div className="relative min-h-screen bg-[#000000] p-6 font-sans text-white selection:bg-[#1c69d4] selection:text-white md:p-12">
      ...
      <div className="mx-auto max-w-6xl space-y-12 pt-2">
        ...
        <div className="flex flex-col justify-between gap-4 border-b border-[#3c3c3c] pb-6 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-1 font-mono text-[11px] uppercase tracking-wide text-[#bbbbbb]">
          ...
          <div className="flex items-center gap-3 font-mono text-xs">
            <button
              ...
              className="flex items-center gap-2 border border-[#3c3c3c] bg-[#1a1a1a] px-4 py-2 font-bold uppercase tracking-wider text-white transition hover:border-white hover:bg-[#222222]"
            >
              <Command className="h-3.5 w-3.5 text-[#1c69d4]" /> COMMAND PALETTE (⌘K)
            </button>

            <div className="flex items-center gap-2 border border-[#3c3c3c] bg-[#1a1a1a] px-4 py-2 font-bold uppercase tracking-widest text-white shadow-md">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="ml-2 text-[#bbbbbb]">
                  OMNIA completed 6 autonomous tasks today. 2 items require attention.
                </span>
              </div>
            </div>

            <div className="flex flex-wrap items-center gap-3 text-[11px]">
              <span className="border border-[#e22718]/40 bg-[#e22718]/10 px-3 py-1 font-bold text-white">
                2 ITEMS REQUIRE ATTENTION
              </span>
              <span className="border border-[#0066b1]/40 bg-[#0066b1]/10 px-3 py-1 font-bold text-white">
        ...
        <div className="relative space-y-6 border border-[#1c69d4]/60 bg-gradient-to-b from-[#1a1a1a] to-[#0d0d0d] p-8 shadow-2xl transition-all duration-200 hover:border-[#1c69d4] md:p-10">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-4 font-mono text-xs">
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 border border-[#3c3c3c] bg-[#0d0d0d] px-6 py-3 font-bold uppercase text-white hover:border-white"
              >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-4 border border-[#3c3c3c] bg-[#1a1a1a] p-6 shadow-2xl md:p-8 lg:col-span-2">
            <div className="flex items-center justify-between border-b border-[#3c3c3c] pb-4 font-mono text-xs">
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 border-t border-[#3c3c3c]/60 pt-2.5">
                    ...
                    <div className="flex items-center gap-2">
                      <a
                        href="/missions"
                        className="inline-flex items-center gap-1 border border-[#3c3c3c] bg-[#1a1a1a] px-3.5 py-1.5 text-[10px] font-bold uppercase text-white transition hover:border-white"
                      >
                        Approve
                      </a>
                      <a
                        href="/missions"
                        className="inline-flex items-center gap-1.5 border border-white bg-white px-4 py-1.5 text-[10px] font-extrabold uppercase text-black transition hover:bg-[#e6e6e6]"
                      >
                        Inspect →
                      </a>
                    </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 border border-[#3c3c3c] bg-[#1a1a1a] p-6 font-mono text-xs shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <a
                  href="/content"
                  className="flex items-center justify-between border border-[#3c3c3c] bg-[#0d0d0d] p-3 text-[11px] font-bold text-white transition hover:border-white"
                >
                  <span>Content</span>
        ...
        <div className="space-y-6 border border-[#3c3c3c] bg-[#1a1a1a] p-6 shadow-2xl md:p-8">
          <div className="flex items-center justify-between border-b border-[#3c3c3c] pb-4 font-mono text-xs">
            <span className="flex items-center gap-2 font-bold uppercase tracking-widest text-white">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {generatedAssets.map((asset, idx) => (
              <div
                key={asset.platform}
                className="space-y-4 border border-[#3c3c3c] bg-[#0d0d0d] p-6 font-mono text-xs shadow-md"
              >
                <div className="flex items-center justify-between border-b border-[#3c3c3c]/60 pb-3">
                ...
                <textarea
                  ...
                  className="h-32 w-full resize-none border border-[#3c3c3c] bg-[#000000] p-4 font-sans text-xs leading-relaxed text-[#e6e6e6] outline-none focus:border-white"
                />
                ...
                <div className="flex items-center justify-end gap-3 text-[11px]">
                  ...
                  <a
                    href="/content"
                    className="border border-white bg-white px-5 py-1.5 font-extrabold uppercase text-black hover:bg-[#e6e6e6]"
                  >
                    Publish →
                  </a>
                </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="space-y-6 border border-[#3c3c3c] bg-[#1a1a1a] p-6 shadow-2xl md:p-8">
            <div className="flex items-center justify-between border-b border-[#3c3c3c] pb-4 font-mono text-xs">
              ...
              <a
                href="/community"
                className="text-[11px] font-bold uppercase text-[#0066b1] hover:underline"
              >
                Open Workspace →
              </a>
            </div>
            ...
            <div className="space-y-4 font-mono text-xs">
              <div className="border border-[#3c3c3c] bg-[#0d0d0d] p-5">
                <span className="font-bold text-white">TOP REQUESTED TOPIC</span>
                <p className="mt-1.5 font-sans text-sm text-[#e6e6e6]">
          ...
          <div className="space-y-6 border border-[#3c3c3c] bg-[#1a1a1a] p-6 shadow-2xl md:p-8">
            ...
            <div className="space-y-4 font-mono text-xs">
              <div className="flex items-center justify-between border border-[#3c3c3c] bg-[#0d0d0d] p-5">
                <div>
                  <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between border border-[#3c3c3c] bg-[#0d0d0d] p-5">
                ...
                <a
                  href="/sponsors"
                  className="border border-[#3c3c3c] bg-[#1a1a1a] px-5 py-2 font-bold uppercase text-white hover:border-white"
                >
                  Review →
                </a>
              </div>
        ...
        <div className="space-y-6 border border-[#3c3c3c] bg-[#1a1a1a] p-6 font-mono text-xs shadow-2xl md:p-8">
          <div className="border-b border-[#3c3c3c] pb-4 font-bold uppercase tracking-widest text-white">
            {"///"} RECENT AUTONOMOUS AI ACTIVITY LOG
          </div>

          <div className="space-y-4 text-[#e6e6e6]">
            <div className="flex items-center justify-between border-b border-[#3c3c3c]/40 pb-3">
              <div className="flex items-center gap-3">
